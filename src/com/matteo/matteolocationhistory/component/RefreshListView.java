...
public class RefreshListView  extends ListView implements OnScrollListener {
	...
	public void AddFooter(){
		...
		this.llFooter = (LinearLayout) LayoutInflater.from(this.ctxParent).inflate(R.layout.pic_list_footer_layout, null);
	...
	private void SetRefreshDoneText(){
    	tvRefreshDown.setText("下拉刷新");
    	pbRefresh.setVisibility(View.INVISIBLE);
    	tvRefreshUp.setText(Fun.ParseDate(new Date()));
